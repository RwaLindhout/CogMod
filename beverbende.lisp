...
;Deze chunk is alleen voor het begin van het spel aangezien je dan meekrijgt wat je meest linker en rechter kaart zijn
(chunk-type start-info left right)
;Get the value of the disard card and the first drawn card, then you can decide. 
...
;Laten we zeggen dat dit vanuit swift meekomt. 
